...
<html lang="en">
  ...
  <div class="row no-gutters mt-5">
    ...
    <li class="nav-item">
      <a class="nav-link text-white" href="logout.html"><i class="fas fa-sign-out-alt mr-3"></i>Logout </a><hr class="bg-secondary">
    </li>
  </ul>
    </div>
    <div class="col-md-10 p-5 pt-2">
      <h3><i class="fas fa-clipboard mr-2"> DAFTAR PEMILIH</i></h3><hr>

      <a href="" class="btn btn-primary mb-3"><i class="fas fa-user-plus mr-2"></i>TAMBAH DATA PEMILIH </a>
      ...
      <thead>
        ...
        <?php
          $no = 1;
          $tampil = mysqli_query($koneksi, "SELECT * FROM tb_pemilih order by no desc");
          ...
          <td><?=$no++; ?>
            <td><?=$data['nama']; ?>
              <td><?=$data['nim']; ?>
                <td><?=$data['status']; ?>
                  <td>
                       <a href="edit_pemilih.php?no=<?php echo $data['no'] ?>" class="btn btn-warning"> Edit </a>
